    ...
    <main id="main" class="main">
        ...
        <form action="{{route("Inventory.update",$inventory)}}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <input type="number" class="form-control"  name="Previous_price" value="{{$inventory->Previous_price}}" required>
            </div>
            ...
            <div class="row mb-3">
                ...
                <input type="number" class="form-control"  name="Current_price" value="{{$inventory->Current_price}}" required>
            </div>
