...
@section('content')
    <main id="main" class="main">
        <br>
        <form action="{{route("Table.update",$table->number)}}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-3">
                ...
                <input type="text" class="form-control"  name="number" value="{{$table->number}}" required>
            </div>
            ...
            <div class="row mb-3">
                ...
                <input type="text" class="form-control"  name="number_chairs" value="{{$table->number_chairs}}" required>
