    ...
    <main id="main" class="main">
        <br>
            ...
            <div class="row mb-3">
                ...
                <select class="form-control" name="category_id" required>
                    ...
                    @foreach($category as $x)
                        <option value="{{$x->id}}" {{ $x->id == $product->category_id ? 'selected' : '' }}>
                            {{$x->name}}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="row mb-3">
                ...
                @endif
                <input type="number" class="form-control" name="total_calories" value="{{$product->total_calories}}" required>
            </div>
            ...
            <div class="row mb-3">
                ...
                @endif
                <input type="number" class="form-control" name="protien" value="{{$product->protien}}" step="1" >
            </div>
            ...
            <div class="row mb-3">
                ...
                @endif
                <input type="number" class="form-control" name="carb" step="1" value="{{$product->carb}}" required>
            </div>
            ...
            <div class="row mb-3">
                ...
                @endif
                <input type="number" class="form-control" name="fat" step="1" value="{{$product->fat}}" required>
            </div>
